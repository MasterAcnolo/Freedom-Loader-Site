...
Please change the parent <Route path="${U}"> to <Route path="${U==="/"?"*":`${U}/*`}">.`)}let M=Yt(),N;if(f){let U=typeof f=="string"?Ul(f):f;Ne(S==="/"||U.pathname?.startsWith(S),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${S}" but pathname "${U.pathname}" was given in the \`location\` prop.`),N=U}else N=M;let L=N.pathname||"/",Z=L;if(S!=="/"){let U=S.replace(/^\//,"").split("/");Z="/"+L.replace(/^\//,"").split("/").slice(U.length).join("/")}let Q=mm(o,{pathname:Z});Bt(y||Q!=null,`No routes matched location "${N.pathname}${N.search}${N.hash}" `),Bt(Q==null||Q[Q.length-1].route.element!==void 0||Q[Q.length-1].route.Component!==void 0||Q[Q.length-1].route.lazy!==void 0,`Matched leaf route at location "${N.pathname}${N.search}${N.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let Y=Pg(Q&&Q.map(U=>Object.assign({},U,{params:Object.assign({},v,U.params),pathname:qt([S,c.encodeLocation?c.encodeLocation(U.pathname.replace(/%/g,"%25").replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:U.pathname]),pathnameBase:U.pathnameBase==="/"?S:qt([S,c.encodeLocation?c.encodeLocation(U.pathnameBase.replace(/%/g,"%25").replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:U.pathnameBase])})),m,d);return f&&Y?z.createElement(Un.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",unstable_mask:void 0,...N},navigationType:"POP"}},Y):Y}function Fg(){let o=n0(),f=Ug(o)?`${o.status} ${o.statusText}`:o instanceof Error?o.message:JSON.stringify(o),d=o instanceof Error?o.stack:null,c="rgba(200,200,200, 0.5)",m={padding:"0.5rem",backgroundColor:c},p={padding:"2px 4px",backgroundColor:c},v=null;return console.error("Error handled by React Router default ErrorBoundary:",o),v=z.createElement(z.Fragment,null,z.createElement("p",null,"💿 Hey developer 👋"),z.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",z.createElement("code",{style:p},"ErrorBoundary")," or"," ",z.createElement("code",{style:p},"errorElement")," prop on your route.")),z.createElement(z.Fragment,null,z.createElement("h2",null,"Unexpected Application Error!"),z.createElement("h3",{style:{fontStyle:"italic"}},f),d?z.createElement("pre",{style:m},d):null,v)}var Wg=z.createElement(Fg,null),Tm=class extends z.Component{constructor(o){super(o),this.state={location:o.location,revalidation:o.revalidation,error:o.error}}static getDerivedStateFromError(o){return{error:o}}static getDerivedStateFromProps(o,f){return f.location!==o.location||f.revalidation!=="idle"&&o.revalidation==="idle"?{error:o.error,location:o.location,revalidation:o.revalidation}:{error:o.error!==void 0?o.error:f.error,location:f.location,revalidation:o.revalidation||f.revalidation}}componentDidCatch(o,f){this.props.onError?this.props.onError(o,f):console.error("React Router caught the following error during render",o)}render(){let o=this.state.error;if(this.context&&typeof o=="object"&&o&&"digest"in o&&typeof o.digest=="string"){const d=Qg(o.digest);d&&(o=d)}let f=o!==void 0?z.createElement(ra.Provider,{value:this.props.routeContext},z.createElement(Yu.Provider,{value:o,children:this.props.component})):this.props.children;return this.context?z.createElement($g,{error:o},f):f}};Tm.contextType=bm;var Ou=new WeakMap;function $g({children:o,error:f}){let{basename:d}=z.useContext(At);if(typeof f=="object"&&f&&"digest"in f&&typeof f.digest=="string"){let c=Xg(f.digest);if(c){let m=Ou.get(f);if(m)throw m;let p=ym(c.location,d);if(vm&&!Ou.get(f))if(p.isExternal||c.reloadDocument)window.location.href=p.absoluteURL||p.to;else{const v=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(p.to,{replace:c.replace}));throw Ou.set(f,v),v}return z.createElement("meta",{httpEquiv:"refresh",content:`0;url=${p.absoluteURL||p.to}`})}}return o}function Ig({routeContext:o,match:f,children:d}){let c=z.useContext(Ll);return c&&c.static&&c.staticContext&&(f.route.errorElement||f.route.ErrorBoundary)&&(c.staticContext._deepestRenderedBoundaryId=f.route.id),z.createElement(ra.Provider,{value:o},d)}function Pg(o,f=[],d){let c=d?.state;if(o==null){if(!c)return null;if(c.errors)o=c.matches;else if(f.length===0&&!c.initialized&&c.matches.length>0)o=c.matches;else return null}let m=o,p=c?.errors;if(p!=null){let M=m.findIndex(N=>N.route.id&&p?.[N.route.id]!==void 0);Ne(M>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(p).join(",")}`),m=m.slice(0,Math.min(m.length,M+1))}let v=!1,T=-1;if(d&&c){v=c.renderFallback;for(let M=0;M<m.length;M++){let N=m[M];if((N.route.HydrateFallback||N.route.hydrateFallbackElement)&&(T=M),N.route.id){let{loaderData:L,errors:Z}=c,Q=N.route.loader&&!L.hasOwnProperty(N.route.id)&&(!Z||Z[N.route.id]===void 0);if(N.route.lazy||Q){d.isStatic&&(v=!0),T>=0?m=m.slice(0,T+1):m=[m[0]];break}}}}let S=d?.onError,y=c&&S?(M,N)=>{S(M,{location:c.location,params:c.matches?.[0]?.params??{},unstable_pattern:Lg(c.matches),errorInfo:N})}:void 0;return m.reduceRight((M,N,L)=>{let Z,Q=!1,Y=null,U=null;c&&(Z=p&&N.route.id?p[N.route.id]:void 0,Y=N.route.errorElement||Wg,v&&(T<0&&L===0?(Nm("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),Q=!0,U=null):T===L&&(Q=!0,U=N.route.hydrateFallbackElement||null)));let K=f.concat(m.slice(0,L+1)),ee=()=>{let J;return Z?J=Y:Q?J=U:N.route.Component?J=z.createElement(N.route.Component,null):N.route.element?J=N.route.element:J=M,z.createElement(Ig,{match:N,routeContext:{outlet:M,matches:K,isDataRoute:c!=null},children:J})};return c&&(N.route.ErrorBoundary||N.route.errorElement||L===0)?z.createElement(Tm,{location:c.location,revalidation:c.revalidation,component:Y,error:Z,children:ee(),routeContext:{outlet:null,matches:K,isDataRoute:!0},onError:y}):ee()},null)}function ku(o){return`${o} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function e0(o){let f=z.useContext(Ll);return Ne(f,ku(o)),f}function t0(o){let f=z.useContext(rr);return Ne(f,ku(o)),f}function a0(o){let f=z.useContext(ra);return Ne(f,ku(o)),f}function Gu(o){let f=a0(o),d=f.matches[f.matches.length-1];return Ne(d.route.id,`${o} can only be used on routes that contain a unique "id"`),d.route.id}function l0(){return Gu("useRouteId")}function n0(){let o=z.useContext(Yu),f=t0("useRouteError"),d=Gu("useRouteError");return o!==void 0?o:f.errors?.[d]}function i0(){let{router:o}=e0("useNavigate"),f=Gu("useNavigate"),d=z.useRef(!1);return zm(()=>{d.current=!0}),z.useCallback(async(m,p={})=>{Bt(d.current,wm),d.current&&(typeof m=="number"?await o.navigate(m):await o.navigate(m,{fromRouteId:f,...p}))},[o,f])}var sm={};function Nm(o,f,d){!f&&!sm[o]&&(sm[o]=!0,Bt(!1,d))}z.memo(r0);function r0({routes:o,future:f,state:d,isStatic:c,onError:m}){return Em(o,void 0,{state:d,isStatic:c,onError:m})}function Nt(o){Ne(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function o0({basename:o="/",children:f=null,location:d,navigationType:c="POP",navigator:m,static:p=!1,unstable_useTransitions:v}){Ne(!Ln(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let T=o.replace(/^\/*/,"/"),S=z.useMemo(()=>({basename:T,navigator:m,static:p,unstable_useTransitions:v,future:{}}),[T,m,p,v]);typeof d=="string"&&(d=Ul(d));let{pathname:y="/",search:M="",hash:N="",state:L=null,key:Z="default",unstable_mask:Q}=d,Y=z.useMemo(()=>{let U=ia(y,T);return U==null?null:{location:{pathname:U,search:M,hash:N,state:L,key:Z,unstable_mask:Q},navigationType:c}},[T,y,M,N,L,Z,c,Q]);return Bt(Y!=null,`<Router basename="${T}"> is not able to match the URL "${y}${M}${N}" because it does not start with the basename, so the <Router> won't render anything.`),Y==null?null:z.createElement(At.Provider,{value:S},z.createElement(Un.Provider,{children:f,value:Y}))}function u0({children:o,location:f}){return Jg(Hu(o),f)}function Hu(o,f=[]){let d=[];return z.Children.forEach(o,(c,m)=>{if(!z.isValidElement(c))return;let p=[...f,m];if(c.type===z.Fragment){d.push.apply(d,Hu(c.props.children,p));return}Ne(c.type===Nt,`[${typeof c.type=="string"?c.type:c.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Ne(!c.props.index||!c.props.children,"An index route cannot have child routes.");let v={id:c.props.id||p.join("-"),caseSensitive:c.props.caseSensitive,element:c.props.element,Component:c.props.Component,index:c.props.index,path:c.props.path,middleware:c.props.middleware,loader:c.props.loader,action:c.props.action,hydrateFallbackElement:c.props.hydrateFallbackElement,HydrateFallback:c.props.HydrateFallback,errorElement:c.props.errorElement,ErrorBoundary:c.props.ErrorBoundary,hasErrorBoundary:c.props.hasErrorBoundary===!0||c.props.ErrorBoundary!=null||c.props.errorElement!=null,shouldRevalidate:c.props.shouldRevalidate,handle:c.props.handle,lazy:c.props.lazy};c.props.children&&(v.children=Hu(c.props.children,p)),d.push(v)}),d}var lr="get",nr="application/x-www-form-urlencoded";function or(o){return typeof HTMLElement<"u"&&o instanceof HTMLElement}function c0(o){return or(o)&&o.tagName.toLowerCase()==="button"}function s0(o){return or(o)&&o.tagName.toLowerCase()==="form"}function f0(o){return or(o)&&o.tagName.toLowerCase()==="input"}function d0(o){return!!(o.metaKey||o.altKey||o.ctrlKey||o.shiftKey)}function m0(o,f){return o.button===0&&(!f||f==="_self")&&!d0(o)}var ar=null;function h0(){if(ar===null)try{new FormData(document.createElement("form"),0),ar=!1}catch{ar=!0}return ar}var p0=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Uu(o){return o!=null&&!p0.has(o)?(Bt(!1,`"${o}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${nr}"`),null):o}function g0(o,f){let d,c,m,p,v;if(s0(o)){let T=o.getAttribute("action");c=T?ia(T,f):null,d=o.getAttribute("method")||lr,m=Uu(o.getAttribute("enctype"))||nr,p=new FormData(o)}else if(c0(o)||f0(o)&&(o.type==="submit"||o.type==="image")){let T=o.form;if(T==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let S=o.getAttribute("formaction")||T.getAttribute("action");if(c=S?ia(S,f):null,d=o.getAttribute("formmethod")||T.getAttribute("method")||lr,m=Uu(o.getAttribute("formenctype"))||Uu(T.getAttribute("enctype"))||nr,p=new FormData(T,o),!h0()){let{name:y,type:M,value:N}=o;if(M==="image"){let L=y?`${y}.`:"";p.append(`${L}x`,"0"),p.append(`${L}y`,"0")}else y&&p.append(y,N)}}else{if(or(o))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');d=lr,c=null,m=nr,v=o}return p&&m==="text/plain"&&(v=p,p=void 0),{action:c,method:d.toLowerCase(),encType:m,formData:p,body:v}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Xu(o,f){if(o===!1||o===null||typeof o>"u")throw new Error(f)}function Am(o,f,d,c){let m=typeof o=="string"?new URL(o,typeof window>"u"?"server://singlefetch/":window.location.origin):o;return d?m.pathname.endsWith("/")?m.pathname=`${m.pathname}_.${c}`:m.pathname=`${m.pathname}.${c}`:m.pathname==="/"?m.pathname=`_root.${c}`:f&&ia(m.pathname,f)==="/"?m.pathname=`${f.replace(/\/$/,"")}/_root.${c}`:m.pathname=`${m.pathname.replace(/\/$/,"")}.${c}`,m}async function v0(o,f){if(o.id in f)return f[o.id];try{let d=await import(o.module);return f[o.id]=d,d}catch(d){return console.error(`Error loading route module \`${o.module}\`, reloading page...`),console.error(d),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function y0(o){return o==null?!1:o.href==null?o.rel==="preload"&&typeof o.imageSrcSet=="string"&&typeof o.imageSizes=="string":typeof o.rel=="string"&&typeof o.href=="string"}async function x0(o,f,d){let c=await Promise.all(o.map(async m=>{let p=f.routes[m.route.id];if(p){let v=await v0(p,d);return v.links?v.links():[]}return[]}));return w0(c.flat(1).filter(y0).filter(m=>m.rel==="stylesheet"||m.rel==="preload").map(m=>m.rel==="stylesheet"?{...m,rel:"prefetch",as:"style"}:{...m,rel:"prefetch"}))}function fm(o,f,d,c,m,p){let v=(S,y)=>d[y]?S.route.id!==d[y].route.id:!0,T=(S,y)=>d[y].pathname!==S.pathname||d[y].route.path?.endsWith("*")&&d[y].params["*"]!==S.params["*"];return p==="assets"?f.filter((S,y)=>v(S,y)||T(S,y)):p==="data"?f.filter((S,y)=>{let M=c.routes[S.route.id];if(!M||!M.hasLoader)return!1;if(v(S,y)||T(S,y))return!0;if(S.route.shouldRevalidate){let N=S.route.shouldRevalidate({currentUrl:new URL(m.pathname+m.search+m.hash,window.origin),currentParams:d[0]?.params||{},nextUrl:new URL(o,window.origin),nextParams:S.params,defaultShouldRevalidate:!0});if(typeof N=="boolean")return N}return!0}):[]}function b0(o,f,{includeHydrateFallback:d}={}){return S0(o.map(c=>{let m=f.routes[c.route.id];if(!m)return[];let p=[m.module];return m.clientActionModule&&(p=p.concat(m.clientActionModule)),m.clientLoaderModule&&(p=p.concat(m.clientLoaderModule)),d&&m.hydrateFallbackModule&&(p=p.concat(m.hydrateFallbackModule)),m.imports&&(p=p.concat(m.imports)),p}).flat(1))}function S0(o){return[...new Set(o)]}function j0(o){let f={},d=Object.keys(o).sort();for(let c of d)f[c]=o[c];return f}function w0(o,f){let d=new Set;return new Set(f),o.reduce((c,m)=>{let p=JSON.stringify(j0(m));return d.has(p)||(d.add(p),c.push({key:p,link:m})),c},[])}function Qu(){let o=z.useContext(Ll);return Xu(o,"You must render this element inside a <DataRouterContext.Provider> element"),o}function z0(){let o=z.useContext(rr);return Xu(o,"You must render this element inside a <DataRouterStateContext.Provider> element"),o}var Vu=z.createContext(void 0);Vu.displayName="FrameworkContext";function Zu(){let o=z.useContext(Vu);return Xu(o,"You must render this element inside a <HydratedRouter> element"),o}function E0(o,f){let d=z.useContext(Vu),[c,m]=z.useState(!1),[p,v]=z.useState(!1),{onFocus:T,onBlur:S,onMouseEnter:y,onMouseLeave:M,onTouchStart:N}=f,L=z.useRef(null);z.useEffect(()=>{if(o==="render"&&v(!0),o==="viewport"){let Y=K=>{K.forEach(ee=>{v(ee.isIntersecting)})},U=new IntersectionObserver(Y,{threshold:.5});return L.current&&U.observe(L.current),()=>{U.disconnect()}}},[o]),z.useEffect(()=>{if(c){let Y=setTimeout(()=>{v(!0)},100);return()=>{clearTimeout(Y)}}},[c]);let Z=()=>{m(!0)},Q=()=>{m(!1),v(!1)};return d?o!=="intent"?[p,L,{}]:[p,L,{onFocus:_n(T,Z),onBlur:_n(S,Q),onMouseEnter:_n(y,Z),onMouseLeave:_n(M,Q),onTouchStart:_n(N,Z)}]:[!1,L,{}]}function _n(o,f){return d=>{o&&o(d),d.defaultPrevented||f(d)}}function T0({page:o,...f}){let d=qg(),{router:c}=Qu(),m=z.useMemo(()=>mm(c.routes,o,c.basename),[c.routes,o,c.basename]);return m?d?z.createElement(A0,{page:o,matches:m,...f}):z.createElement(C0,{page:o,matches:m,...f}):null}function N0(o){let{manifest:f,routeModules:d}=Zu(),[c,m]=z.useState([]);return z.useEffect(()=>{let p=!1;return x0(o,f,d).then(v=>{p||m(v)}),()=>{p=!0}},[o,f,d]),c}function A0({page:o,matches:f,...d}){let c=Yt(),{future:m}=Zu(),{basename:p}=Qu(),v=z.useMemo(()=>{if(o===c.pathname+c.search+c.hash)return[];let T=Am(o,p,m.unstable_trailingSlashAwareDataRequests,"rsc"),S=!1,y=[];for(let M of f)typeof M.route.shouldRevalidate=="function"?S=!0:y.push(M.route.id);return S&&y.length>0&&T.searchParams.set("_routes",y.join(",")),[T.pathname+T.search]},[p,m.unstable_trailingSlashAwareDataRequests,o,c,f]);return z.createElement(z.Fragment,null,v.map(T=>z.createElement("link",{key:T,rel:"prefetch",as:"fetch",href:T,...d})))}function C0({page:o,matches:f,...d}){let c=Yt(),{future:m,manifest:p,routeModules:v}=Zu(),{basename:T}=Qu(),{loaderData:S,matches:y}=z0(),M=z.useMemo(()=>fm(o,f,y,p,c,"data"),[o,f,y,p,c]),N=z.useMemo(()=>fm(o,f,y,p,c,"assets"),[o,f,y,p,c]),L=z.useMemo(()=>{if(o===c.pathname+c.search+c.hash)return[];let Y=new Set,U=!1;if(f.forEach(ee=>{let J=p.routes[ee.route.id];!J||!J.hasLoader||(!M.some(xe=>xe.route.id===ee.route.id)&&ee.route.id in S&&v[ee.route.id]?.shouldRevalidate||J.hasClientLoader?U=!0:Y.add(ee.route.id))}),Y.size===0)return[];let K=Am(o,T,m.unstable_trailingSlashAwareDataRequests,"data");return U&&Y.size>0&&K.searchParams.set("_routes",f.filter(ee=>Y.has(ee.route.id)).map(ee=>ee.route.id).join(",")),[K.pathname+K.search]},[T,m.unstable_trailingSlashAwareDataRequests,S,c,p,M,f,o,v]),Z=z.useMemo(()=>b0(N,p),[N,p]),Q=N0(N);return z.createElement(z.Fragment,null,L.map(Y=>z.createElement("link",{key:Y,rel:"prefetch",as:"fetch",href:Y,...d})),Z.map(Y=>z.createElement("link",{key:Y,rel:"modulepreload",href:Y,...d})),Q.map(({key:Y,link:U})=>z.createElement("link",{key:Y,nonce:d.nonce,...U,crossOrigin:U.crossOrigin??d.crossOrigin})))}function R0(...o){return f=>{o.forEach(d=>{typeof d=="function"?d(f):d!=null&&(d.current=f)})}}var D0=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{D0&&(window.__reactRouterVersion="7.14.0")}catch{}function M0({basename:o,children:f,unstable_useTransitions:d,window:c}){let m=z.useRef();m.current==null&&(m.current=fg({window:c,v5Compat:!0}));let p=m.current,[v,T]=z.useState({action:p.action,location:p.location}),S=z.useCallback(y=>{d===!1?T(y):z.startTransition(()=>T(y))},[d]);return z.useLayoutEffect(()=>p.listen(S),[p,S]),z.createElement(o0,{basename:o,children:f,location:v.location,navigationType:v.action,navigator:p,unstable_useTransitions:d})}var Cm=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,se=z.forwardRef(function({onClick:f,discover:d="render",prefetch:c="none",relative:m,reloadDocument:p,replace:v,unstable_mask:T,state:S,target:y,to:M,preventScrollReset:N,viewTransition:L,unstable_defaultShouldRevalidate:Z,...Q},Y){let{basename:U,navigator:K,unstable_useTransitions:ee}=z.useContext(At),J=typeof M=="string"&&Cm.test(M),xe=ym(M,U);M=xe.to;let be=Vg(M,{relative:m}),Te=Yt(),W=null;if(T){let Oe=Bu(T,[],Te.unstable_mask?Te.unstable_mask.pathname:"/",!0);U!=="/"&&(Oe.pathname=Oe.pathname==="/"?U:qt([U,Oe.pathname])),W=K.createHref(Oe)}let[Re,Ke,Mt]=E0(c,Q),pt=L0(M,{replace:v,unstable_mask:T,state:S,target:y,preventScrollReset:N,relative:m,viewTransition:L,unstable_defaultShouldRevalidate:Z,unstable_useTransitions:ee});function Je(Oe){f&&f(Oe),Oe.defaultPrevented||pt(Oe)}let _t=!(xe.isExternal||p),gt=z.createElement("a",{...Q,...Mt,href:(_t?W:void 0)||xe.absoluteURL||be,onClick:_t?Je:f,ref:R0(Y,Ke),target:y,"data-discover":!J&&d==="render"?"true":void 0});return Re&&!J?z.createElement(z.Fragment,null,gt,z.createElement(T0,{page:be})):gt});se.displayName="Link";var _0=z.forwardRef(function({"aria-current":f="page",caseSensitive:d=!1,className:c="",end:m=!1,style:p,to:v,viewTransition:T,children:S,...y},M){let N=Hn(v,{relative:y.relative}),L=Yt(),Z=z.useContext(rr),{navigator:Q,basename:Y}=z.useContext(At),U=Z!=null&&k0(N)&&T===!0,K=Q.encodeLocation?Q.encodeLocation(N).pathname:N.pathname,ee=L.pathname,J=Z&&Z.navigation&&Z.navigation.location?Z.navigation.location.pathname:null;d||(ee=ee.toLowerCase(),J=J?J.toLowerCase():null,K=K.toLowerCase()),J&&Y&&(J=ia(J,Y)||J);const xe=K!=="/"&&K.endsWith("/")?K.length-1:K.length;let be=ee===K||!m&&ee.startsWith(K)&&ee.charAt(xe)==="/",Te=J!=null&&(J===K||!m&&J.startsWith(K)&&J.charAt(K.length)==="/"),W={isActive:be,isPending:Te,isTransitioning:U},Re=be?f:void 0,Ke;typeof c=="function"?Ke=c(W):Ke=[c,be?"active":null,Te?"pending":null,U?"transitioning":null].filter(Boolean).join(" ");let Mt=typeof p=="function"?p(W):p;return z.createElement(se,{...y,"aria-current":Re,className:Ke,ref:M,style:Mt,to:v,viewTransition:T},typeof S=="function"?S(W):S)});_0.displayName="NavLink";var O0=z.forwardRef(({discover:o="render",fetcherKey:f,navigate:d,reloadDocument:c,replace:m,state:p,method:v=lr,action:T,onSubmit:S,relative:y,preventScrollReset:M,viewTransition:N,unstable_defaultShouldRevalidate:L,...Z},Q)=>{let{unstable_useTransitions:Y}=z.useContext(At),U=B0(),K=Y0(T,{relative:y}),ee=v.toLowerCase()==="get"?"get":"post",J=typeof T=="string"&&Cm.test(T),xe=be=>{if(S&&S(be),be.defaultPrevented)return;be.preventDefault();let Te=be.nativeEvent.submitter,W=Te?.getAttribute("formmethod")||v,Re=()=>U(Te||be.currentTarget,{fetcherKey:f,method:W,navigate:d,replace:m,state:p,relative:y,preventScrollReset:M,viewTransition:N,unstable_defaultShouldRevalidate:L});Y&&d!==!1?z.startTransition(()=>Re()):Re()};return z.createElement("form",{ref:Q,method:ee,action:K,onSubmit:c?S:xe,...Z,"data-discover":!J&&o==="render"?"true":void 0})});O0.displayName="Form";function U0(o){return`${o} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Rm(o){let f=z.useContext(Ll);return Ne(f,U0(o)),f}function L0(o,{target:f,replace:d,unstable_mask:c,state:m,preventScrollReset:p,relative:v,viewTransition:T,unstable_defaultShouldRevalidate:S,unstable_useTransitions:y}={}){let M=Zg(),N=Yt(),L=Hn(o,{relative:v});return z.useCallback(Z=>{if(m0(Z,f)){Z.preventDefault();let Q=d!==void 0?d:On(N)===On(L),Y=()=>M(o,{replace:Q,unstable_mask:c,state:m,preventScrollReset:p,relative:v,viewTransition:T,unstable_defaultShouldRevalidate:S});y?z.startTransition(()=>Y()):Y()}},[N,M,L,d,c,m,f,o,p,v,T,S,y])}var H0=0,q0=()=>`__${String(++H0)}__`;function B0(){let{router:o}=Rm("useSubmit"),{basename:f}=z.useContext(At),d=l0(),c=o.fetch,m=o.navigate;return z.useCallback(async(p,v={})=>{let{action:T,method:S,encType:y,formData:M,body:N}=g0(p,f);if(v.navigate===!1){let L=v.fetcherKey||q0();await c(L,d,v.action||T,{unstable_defaultShouldRevalidate:v.unstable_defaultShouldRevalidate,preventScrollReset:v.preventScrollReset,formData:M,body:N,formMethod:v.method||S,formEncType:v.encType||y,flushSync:v.flushSync})}else await m(v.action||T,{unstable_defaultShouldRevalidate:v.unstable_defaultShouldRevalidate,preventScrollReset:v.preventScrollReset,formData:M,body:N,formMethod:v.method||S,formEncType:v.encType||y,replace:v.replace,state:v.state,fromRouteId:d,flushSync:v.flushSync,viewTransition:v.viewTransition})},[c,m,f,d])}function Y0(o,{relative:f}={}){let{basename:d}=z.useContext(At),c=z.useContext(ra);Ne(c,"useFormAction must be used inside a RouteContext");let[m]=c.matches.slice(-1),p={...Hn(o||".",{relative:f})},v=Yt();if(o==null){p.search=v.search;let T=new URLSearchParams(p.search),S=T.getAll("index");if(S.some(M=>M==="")){T.delete("index"),S.filter(N=>N).forEach(N=>T.append("index",N));let M=T.toString();p.search=M?`?${M}`:""}}return(!o||o===".")&&m.route.index&&(p.search=p.search?p.search.replace(/^\?/,"?index&"):"?index"),d!=="/"&&(p.pathname=p.pathname==="/"?d:qt([d,p.pathname])),On(p)}function k0(o,{relative:f}={}){let d=z.useContext(Sm);Ne(d!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:c}=Rm("useViewTransitionState"),m=Hn(o,{relative:f});if(!d.isTransitioning)return!1;let p=ia(d.currentLocation.pathname,c)||d.currentLocation.pathname,v=ia(d.nextLocation.pathname,c)||d.nextLocation.pathname;return ir(m.pathname,v)!=null||ir(m.pathname,p)!=null}function G0(){const[o,f]=z.useState(!0);return z.useEffect(()=>{const d=setTimeout(()=>{f(!1)},500);return()=>clearTimeout(d)},[]),r.jsxs("div",{id:"loader",style:{opacity:o?1:0,transition:"opacity 0.5s ease",pointerEvents:o?"auto":"none"},children:[r.jsx("div",{className:"spinner"}),r.jsx("p",{className:"loader-text",children:"Loading..."})]})}function Dm(){const[o,f]=z.useState(null);z.useEffect(()=>{const m=localStorage.getItem("theme");if(m)f(m==="dark"),d(m);else{const p=window.matchMedia("(prefers-color-scheme: dark)").matches;f(p),d(p?"dark":"light")}},[]);const d=m=>{document.documentElement.classList.remove("light-theme","dark-theme"),m==="light"?document.documentElement.classList.add("light-theme"):document.documentElement.classList.add("dark-theme"),localStorage.setItem("theme",m)},c=()=>{const m=o?"light":"dark";f(!o),d(m)};return o===null?null:r.jsx("button",{onClick:c,title:o?"Switch to Light Mode":"Switch to Dark Mode",style:{background:"transparent",border:"none",color:"inherit",cursor:"pointer",fontSize:"1.2rem",padding:"8px",display:"flex",alignItems:"center",justifyContent:"center",width:"36px",height:"36px",transition:"all 0.2s ease"},onMouseEnter:m=>m.target.style.opacity="0.7",onMouseLeave:m=>m.target.style.opacity="1",children:o?r.jsx("i",{className:"fas fa-sun"}):r.jsx("i",{className:"fas fa-moon"})})}function X0({open:o,onClose:f}){return r.jsxs(r.Fragment,{children:[r.jsx("style",{children:`
        ...
        `}),r.jsxs("header",{className:"header",children:[r.jsx(se,{to:"/",className:"logo",children:r.jsx("img",{src:"./assets/icon/Freedom_Loader.png",alt:"logo"})}),r.jsxs("nav",{className:"nav",children:[r.jsxs("div",{className:`item ${o==="project"?"open":""}`,onMouseEnter:()=>f("project"),onMouseLeave:()=>f(null),children:[r.jsxs("div",{className:"trigger",children:["Project ",r.jsx("span",{className:"arrow",children:"▾"})]}),r.jsxs("div",{className:"dropdown",children:[r.jsx(se,{to:"/about",children:"About"}),r.jsx(se,{to:"/features",children:"Features"}),r.jsx(se,{to:"/roadmap",children:"Roadmap"}),r.jsx(se,{to:"/wiki",children:"Wiki"})]})]}),r.jsxs("div",{className:`item ${o==="explore"?"open":""}`,onMouseEnter:()=>f("explore"),onMouseLeave:()=>f(null),children:[r.jsxs("div",{className:"trigger",children:["Explore ",r.jsx("span",{className:"arrow",children:"▾"})]}),r.jsxs("div",{className:"dropdown",children:[r.jsx(se,{to:"/faq",children:"FAQ"}),r.jsx(se,{to:"/contact",children:"Contact"})]})]}),r.jsxs("div",{className:`item ${o==="workshop"?"open":""}`,onMouseEnter:()=>f("workshop"),onMouseLeave:()=>f(null),children:[r.jsxs("div",{className:"trigger",children:["Workshop ",r.jsx("span",{className:"arrow",children:"▾"})]}),r.jsxs("div",{className:"dropdown",children:[r.jsx("a",{href:"https://masteracnolo.github.io/Freedom-Loader-Workshop/",target:"_blank",rel:"noopener noreferrer",children:"Browse Themes"}),r.jsx("a",{href:"https://masteracnolo.github.io/Freedom-Loader-Workshop/create.html",target:"_blank",rel:"noopener noreferrer",children:"Create Theme"})]})]}),r.jsxs("div",{className:`item ${o==="contribute"?"open":""}`,onMouseEnter:()=>f("contribute"),onMouseLeave:()=>f(null),children:[r.jsxs("div",{className:"trigger",children:["Contribute ",r.jsx("span",{className:"arrow",children:"▾"})]}),r.jsxs("div",{className:"dropdown",children:[r.jsx("a",{href:"https://github.com/MasterAcnolo/Freedom-Loader",children:"GitHub"}),r.jsx(se,{to:"/contributing",children:"Guide"})]})]}),r.jsx(se,{to:"/download",className:"header-btn",children:"Download"}),r.jsx(Dm,{})]}),r.jsxs("div",{className:`hamburger ${d?"open":""}`,onClick:()=>c(!d),children:[r.jsx("span",{}),r.jsx("span",{}),r.jsx("span",{})]})]}),r.jsx(X0,{open:d,onClose:()=>c(!1)})]})}function V0(){const o=new Date().getFullYear();return r.jsxs(r.Fragment,{children:[r.jsx("style",{children:`
            ...
            `}),r.jsx("main",{children:r.jsxs("section",{className:"roadmap-page",children:[r.jsxs("div",{className:"roadmap-header",children:[r.jsx("h1",{children:"Roadmap"}),r.jsx("p",{children:"See what's coming next for Freedom Loader. We're constantly innovating and improving."})]}),r.jsx("div",{className:"roadmap-container",children:Object.entries(d).map(([m,p],v)=>r.jsxs("div",{className:`roadmap-section ${m==="Coming Soon"?"coming-soon":m==="Working On"?"in-dev":"future"}`,children:[r.jsxs("div",{className:"section-header",children:[r.jsx("div",{className:"section-dot",style:{backgroundColor:c[m]}}),r.jsx("h2",{className:"section-title",children:m})]}),r.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:p.map((T,S)=>r.jsxs("div",{className:`roadmap-item ${o===`${m}-${S}`?"expanded":""} ${m==="Coming Soon"?"coming-soon":m==="Working On"?"in-dev":"future"}`,onClick:()=>f(o===`${m}-${S}`?null:`${m}-${S}`),children:[r.jsxs("div",{className:"item-header",children:[r.jsx("h3",{className:"item-title",children:T.title}),r.jsx("i",{className:"fas fa-chevron-down item-icon"})]}),r.jsx("p",{className:"item-desc",children:T.desc})]},S))})]},m))})]})})]})}function av(){return z.useEffect(()=>{document.title="Terms - Freedom Loader"},[]),r.jsxs(r.Fragment,{children:[r.jsx("style",{children:`
                .terms {
                    color: var(--text-primary);
                    padding: 80px 20%;
                    margin-top: 30px;
