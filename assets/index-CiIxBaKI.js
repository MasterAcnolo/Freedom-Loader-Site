...
Please change the parent <Route path="${U}"> to <Route path="${U==="/"?"*":`${U}/*`}">.`)}let M=Bt(),N;if(f){let U=typeof f=="string"?$a(f):f;Ne(b==="/"||U.pathname?.startsWith(b),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${b}" but pathname "${U.pathname}" was given in the \`location\` prop.`),N=U}else N=M;let L=N.pathname||"/",Z=L;if(b!=="/"){let U=b.replace(/^\//,"").split("/");Z="/"+L.replace(/^\//,"").split("/").slice(U.length).join("/")}let Q=mm(u,{pathname:Z});Mt(v||Q!=null,`No routes matched location "${N.pathname}${N.search}${N.hash}" `),Mt(Q==null||Q[Q.length-1].route.element!==void 0||Q[Q.length-1].route.Component!==void 0||Q[Q.length-1].route.lazy!==void 0,`Matched leaf route at location "${N.pathname}${N.search}${N.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let B=Pg(Q&&Q.map(U=>Object.assign({},U,{params:Object.assign({},g,U.params),pathname:Yt([b,c.encodeLocation?c.encodeLocation(U.pathname.replace(/%/g,"%25").replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:U.pathname]),pathnameBase:U.pathnameBase==="/"?b:Yt([b,c.encodeLocation?c.encodeLocation(U.pathnameBase.replace(/%/g,"%25").replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:U.pathnameBase])})),m,d);return f&&B?E.createElement(Un.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",unstable_mask:void 0,...N},navigationType:"POP"}},B):B}function Fg(){let u=n0(),f=Ug(u)?`${u.status} ${u.statusText}`:u instanceof Error?u.message:JSON.stringify(u),d=u instanceof Error?u.stack:null,c="rgba(200,200,200, 0.5)",m={padding:"0.5rem",backgroundColor:c},p={padding:"2px 4px",backgroundColor:c},g=null;return console.error("Error handled by React Router default ErrorBoundary:",u),g=E.createElement(E.Fragment,null,E.createElement("p",null,"💿 Hey developer 👋"),E.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",E.createElement("code",{style:p},"ErrorBoundary")," or"," ",E.createElement("code",{style:p},"errorElement")," prop on your route.")),E.createElement(E.Fragment,null,E.createElement("h2",null,"Unexpected Application Error!"),E.createElement("h3",{style:{fontStyle:"italic"}},f),d?E.createElement("pre",{style:m},d):null,g)}var Wg=E.createElement(Fg,null),Tm=class extends E.Component{constructor(u){super(u),this.state={location:u.location,revalidation:u.revalidation,error:u.error}}static getDerivedStateFromError(u){return{error:u}}static getDerivedStateFromProps(u,f){return f.location!==u.location||f.revalidation!=="idle"&&u.revalidation==="idle"?{error:u.error,location:u.location,revalidation:u.revalidation}:{error:u.error!==void 0?u.error:f.error,location:f.location,revalidation:u.revalidation||f.revalidation}}componentDidCatch(u,f){this.props.onError?this.props.onError(u,f):console.error("React Router caught the following error during render",u)}render(){let u=this.state.error;if(this.context&&typeof u=="object"&&u&&"digest"in u&&typeof u.digest=="string"){const d=Qg(u.digest);d&&(u=d)}let f=u!==void 0?E.createElement(ra.Provider,{value:this.props.routeContext},E.createElement(Bu.Provider,{value:u,children:this.props.component})):this.props.children;return this.context?E.createElement($g,{error:u},f):f}};Tm.contextType=bm;var Ou=new WeakMap;function $g({children:u,error:f}){let{basename:d}=E.useContext(At);if(typeof f=="object"&&f&&"digest"in f&&typeof f.digest=="string"){let c=Xg(f.digest);if(c){let m=Ou.get(f);if(m)throw m;let p=vm(c.location,d);if(ym&&!Ou.get(f))if(p.isExternal||c.reloadDocument)window.location.href=p.absoluteURL||p.to;else{const g=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(p.to,{replace:c.replace}));throw Ou.set(f,g),g}return E.createElement("meta",{httpEquiv:"refresh",content:`0;url=${p.absoluteURL||p.to}`})}}return u}function Ig({routeContext:u,match:f,children:d}){let c=E.useContext(Ll);return c&&c.static&&c.staticContext&&(f.route.errorElement||f.route.ErrorBoundary)&&(c.staticContext._deepestRenderedBoundaryId=f.route.id),E.createElement(ra.Provider,{value:u},d)}function Pg(u,f=[],d){let c=d?.state;if(u==null){if(!c)return null;if(c.errors)u=c.matches;else if(f.length===0&&!c.initialized&&c.matches.length>0)u=c.matches;else return null}let m=u,p=c?.errors;if(p!=null){let M=m.findIndex(N=>N.route.id&&p?.[N.route.id]!==void 0);Ne(M>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(p).join(",")}`),m=m.slice(0,Math.min(m.length,M+1))}let g=!1,T=-1;if(d&&c){g=c.renderFallback;for(let M=0;M<m.length;M++){let N=m[M];if((N.route.HydrateFallback||N.route.hydrateFallbackElement)&&(T=M),N.route.id){let{loaderData:L,errors:Z}=c,Q=N.route.loader&&!L.hasOwnProperty(N.route.id)&&(!Z||Z[N.route.id]===void 0);if(N.route.lazy||Q){d.isStatic&&(g=!0),T>=0?m=m.slice(0,T+1):m=[m[0]];break}}}}let b=d?.onError,v=c&&b?(M,N)=>{b(M,{location:c.location,params:c.matches?.[0]?.params??{},unstable_pattern:Lg(c.matches),errorInfo:N})}:void 0;return m.reduceRight((M,N,L)=>{let Z,Q=!1,B=null,U=null;c&&(Z=p&&N.route.id?p[N.route.id]:void 0,B=N.route.errorElement||Wg,g&&(T<0&&L===0?(Nm("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),Q=!0,U=null):T===L&&(Q=!0,U=N.route.hydrateFallbackElement||null)));let K=f.concat(m.slice(0,L+1)),I=()=>{let J;return Z?J=B:Q?J=U:N.route.Component?J=E.createElement(N.route.Component,null):N.route.element?J=N.route.element:J=M,E.createElement(Ig,{match:N,routeContext:{outlet:M,matches:K,isDataRoute:c!=null},children:J})};return c&&(N.route.ErrorBoundary||N.route.errorElement||L===0)?E.createElement(Tm,{location:c.location,revalidation:c.revalidation,component:B,error:Z,children:I(),routeContext:{outlet:null,matches:K,isDataRoute:!0},onError:v}):I()},null)}function ku(u){return`${u} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function e0(u){let f=E.useContext(Ll);return Ne(f,ku(u)),f}function t0(u){let f=E.useContext(rr);return Ne(f,ku(u)),f}function a0(u){let f=E.useContext(ra);return Ne(f,ku(u)),f}function Gu(u){let f=a0(u),d=f.matches[f.matches.length-1];return Ne(d.route.id,`${u} can only be used on routes that contain a unique "id"`),d.route.id}function l0(){return Gu("useRouteId")}function n0(){let u=E.useContext(Bu),f=t0("useRouteError"),d=Gu("useRouteError");return u!==void 0?u:f.errors?.[d]}function i0(){let{router:u}=e0("useNavigate"),f=Gu("useNavigate"),d=E.useRef(!1);return zm(()=>{d.current=!0}),E.useCallback(async(m,p={})=>{Mt(d.current,wm),d.current&&(typeof m=="number"?await u.navigate(m):await u.navigate(m,{fromRouteId:f,...p}))},[u,f])}var sm={};function Nm(u,f,d){!f&&!sm[u]&&(sm[u]=!0,Mt(!1,d))}E.memo(r0);function r0({routes:u,future:f,state:d,isStatic:c,onError:m}){return Em(u,void 0,{state:d,isStatic:c,onError:m})}function Nt(u){Ne(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function o0({basename:u="/",children:f=null,location:d,navigationType:c="POP",navigator:m,static:p=!1,unstable_useTransitions:g}){Ne(!Ln(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let T=u.replace(/^\/*/,"/"),b=E.useMemo(()=>({basename:T,navigator:m,static:p,unstable_useTransitions:g,future:{}}),[T,m,p,g]);typeof d=="string"&&(d=$a(d));let{pathname:v="/",search:M="",hash:N="",state:L=null,key:Z="default",unstable_mask:Q}=d,B=E.useMemo(()=>{let U=ia(v,T);return U==null?null:{location:{pathname:U,search:M,hash:N,state:L,key:Z,unstable_mask:Q},navigationType:c}},[T,v,M,N,L,Z,c,Q]);return Mt(B!=null,`<Router basename="${T}"> is not able to match the URL "${v}${M}${N}" because it does not start with the basename, so the <Router> won't render anything.`),B==null?null:E.createElement(At.Provider,{value:b},E.createElement(Un.Provider,{children:f,value:B}))}function u0({children:u,location:f}){return Jg(Hu(u),f)}function Hu(u,f=[]){let d=[];return E.Children.forEach(u,(c,m)=>{if(!E.isValidElement(c))return;let p=[...f,m];if(c.type===E.Fragment){d.push.apply(d,Hu(c.props.children,p));return}Ne(c.type===Nt,`[${typeof c.type=="string"?c.type:c.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Ne(!c.props.index||!c.props.children,"An index route cannot have child routes.");let g={id:c.props.id||p.join("-"),caseSensitive:c.props.caseSensitive,element:c.props.element,Component:c.props.Component,index:c.props.index,path:c.props.path,middleware:c.props.middleware,loader:c.props.loader,action:c.props.action,hydrateFallbackElement:c.props.hydrateFallbackElement,HydrateFallback:c.props.HydrateFallback,errorElement:c.props.errorElement,ErrorBoundary:c.props.ErrorBoundary,hasErrorBoundary:c.props.hasErrorBoundary===!0||c.props.ErrorBoundary!=null||c.props.errorElement!=null,shouldRevalidate:c.props.shouldRevalidate,handle:c.props.handle,lazy:c.props.lazy};c.props.children&&(g.children=Hu(c.props.children,p)),d.push(g)}),d}var lr="get",nr="application/x-www-form-urlencoded";function or(u){return typeof HTMLElement<"u"&&u instanceof HTMLElement}function c0(u){return or(u)&&u.tagName.toLowerCase()==="button"}function s0(u){return or(u)&&u.tagName.toLowerCase()==="form"}function f0(u){return or(u)&&u.tagName.toLowerCase()==="input"}function d0(u){return!!(u.metaKey||u.altKey||u.ctrlKey||u.shiftKey)}function m0(u,f){return u.button===0&&(!f||f==="_self")&&!d0(u)}var ar=null;function h0(){if(ar===null)try{new FormData(document.createElement("form"),0),ar=!1}catch{ar=!0}return ar}var p0=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Uu(u){return u!=null&&!p0.has(u)?(Mt(!1,`"${u}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${nr}"`),null):u}function g0(u,f){let d,c,m,p,g;if(s0(u)){let T=u.getAttribute("action");c=T?ia(T,f):null,d=u.getAttribute("method")||lr,m=Uu(u.getAttribute("enctype"))||nr,p=new FormData(u)}else if(c0(u)||f0(u)&&(u.type==="submit"||u.type==="image")){let T=u.form;if(T==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let b=u.getAttribute("formaction")||T.getAttribute("action");if(c=b?ia(b,f):null,d=u.getAttribute("formmethod")||T.getAttribute("method")||lr,m=Uu(u.getAttribute("formenctype"))||Uu(T.getAttribute("enctype"))||nr,p=new FormData(T,u),!h0()){let{name:v,type:M,value:N}=u;if(M==="image"){let L=v?`${v}.`:"";p.append(`${L}x`,"0"),p.append(`${L}y`,"0")}else v&&p.append(v,N)}}else{if(or(u))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');d=lr,c=null,m=nr,g=u}return p&&m==="text/plain"&&(g=p,p=void 0),{action:c,method:d.toLowerCase(),encType:m,formData:p,body:g}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Xu(u,f){if(u===!1||u===null||typeof u>"u")throw new Error(f)}function Am(u,f,d,c){let m=typeof u=="string"?new URL(u,typeof window>"u"?"server://singlefetch/":window.location.origin):u;return d?m.pathname.endsWith("/")?m.pathname=`${m.pathname}_.${c}`:m.pathname=`${m.pathname}.${c}`:m.pathname==="/"?m.pathname=`_root.${c}`:f&&ia(m.pathname,f)==="/"?m.pathname=`${f.replace(/\/$/,"")}/_root.${c}`:m.pathname=`${m.pathname.replace(/\/$/,"")}.${c}`,m}async function y0(u,f){if(u.id in f)return f[u.id];try{let d=await import(u.module);return f[u.id]=d,d}catch(d){return console.error(`Error loading route module \`${u.module}\`, reloading page...`),console.error(d),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function v0(u){return u==null?!1:u.href==null?u.rel==="preload"&&typeof u.imageSrcSet=="string"&&typeof u.imageSizes=="string":typeof u.rel=="string"&&typeof u.href=="string"}async function x0(u,f,d){let c=await Promise.all(u.map(async m=>{let p=f.routes[m.route.id];if(p){let g=await y0(p,d);return g.links?g.links():[]}return[]}));return w0(c.flat(1).filter(v0).filter(m=>m.rel==="stylesheet"||m.rel==="preload").map(m=>m.rel==="stylesheet"?{...m,rel:"prefetch",as:"style"}:{...m,rel:"prefetch"}))}function fm(u,f,d,c,m,p){let g=(b,v)=>d[v]?b.route.id!==d[v].route.id:!0,T=(b,v)=>d[v].pathname!==b.pathname||d[v].route.path?.endsWith("*")&&d[v].params["*"]!==b.params["*"];return p==="assets"?f.filter((b,v)=>g(b,v)||T(b,v)):p==="data"?f.filter((b,v)=>{let M=c.routes[b.route.id];if(!M||!M.hasLoader)return!1;if(g(b,v)||T(b,v))return!0;if(b.route.shouldRevalidate){let N=b.route.shouldRevalidate({currentUrl:new URL(m.pathname+m.search+m.hash,window.origin),currentParams:d[0]?.params||{},nextUrl:new URL(u,window.origin),nextParams:b.params,defaultShouldRevalidate:!0});if(typeof N=="boolean")return N}return!0}):[]}function b0(u,f,{includeHydrateFallback:d}={}){return S0(u.map(c=>{let m=f.routes[c.route.id];if(!m)return[];let p=[m.module];return m.clientActionModule&&(p=p.concat(m.clientActionModule)),m.clientLoaderModule&&(p=p.concat(m.clientLoaderModule)),d&&m.hydrateFallbackModule&&(p=p.concat(m.hydrateFallbackModule)),m.imports&&(p=p.concat(m.imports)),p}).flat(1))}function S0(u){return[...new Set(u)]}function j0(u){let f={},d=Object.keys(u).sort();for(let c of d)f[c]=u[c];return f}function w0(u,f){let d=new Set;return new Set(f),u.reduce((c,m)=>{let p=JSON.stringify(j0(m));return d.has(p)||(d.add(p),c.push({key:p,link:m})),c},[])}function Qu(){let u=E.useContext(Ll);return Xu(u,"You must render this element inside a <DataRouterContext.Provider> element"),u}function z0(){let u=E.useContext(rr);return Xu(u,"You must render this element inside a <DataRouterStateContext.Provider> element"),u}var Vu=E.createContext(void 0);Vu.displayName="FrameworkContext";function Zu(){let u=E.useContext(Vu);return Xu(u,"You must render this element inside a <HydratedRouter> element"),u}function E0(u,f){let d=E.useContext(Vu),[c,m]=E.useState(!1),[p,g]=E.useState(!1),{onFocus:T,onBlur:b,onMouseEnter:v,onMouseLeave:M,onTouchStart:N}=f,L=E.useRef(null);E.useEffect(()=>{if(u==="render"&&g(!0),u==="viewport"){let B=K=>{K.forEach(I=>{g(I.isIntersecting)})},U=new IntersectionObserver(B,{threshold:.5});return L.current&&U.observe(L.current),()=>{U.disconnect()}}},[u]),E.useEffect(()=>{if(c){let B=setTimeout(()=>{g(!0)},100);return()=>{clearTimeout(B)}}},[c]);let Z=()=>{m(!0)},Q=()=>{m(!1),g(!1)};return d?u!=="intent"?[p,L,{}]:[p,L,{onFocus:_n(T,Z),onBlur:_n(b,Q),onMouseEnter:_n(v,Z),onMouseLeave:_n(M,Q),onTouchStart:_n(N,Z)}]:[!1,L,{}]}function _n(u,f){return d=>{u&&u(d),d.defaultPrevented||f(d)}}function T0({page:u,...f}){let d=qg(),{router:c}=Qu(),m=E.useMemo(()=>mm(c.routes,u,c.basename),[c.routes,u,c.basename]);return m?d?E.createElement(A0,{page:u,matches:m,...f}):E.createElement(C0,{page:u,matches:m,...f}):null}function N0(u){let{manifest:f,routeModules:d}=Zu(),[c,m]=E.useState([]);return E.useEffect(()=>{let p=!1;return x0(u,f,d).then(g=>{p||m(g)}),()=>{p=!0}},[u,f,d]),c}function A0({page:u,matches:f,...d}){let c=Bt(),{future:m}=Zu(),{basename:p}=Qu(),g=E.useMemo(()=>{if(u===c.pathname+c.search+c.hash)return[];let T=Am(u,p,m.unstable_trailingSlashAwareDataRequests,"rsc"),b=!1,v=[];for(let M of f)typeof M.route.shouldRevalidate=="function"?b=!0:v.push(M.route.id);return b&&v.length>0&&T.searchParams.set("_routes",v.join(",")),[T.pathname+T.search]},[p,m.unstable_trailingSlashAwareDataRequests,u,c,f]);return E.createElement(E.Fragment,null,g.map(T=>E.createElement("link",{key:T,rel:"prefetch",as:"fetch",href:T,...d})))}function C0({page:u,matches:f,...d}){let c=Bt(),{future:m,manifest:p,routeModules:g}=Zu(),{basename:T}=Qu(),{loaderData:b,matches:v}=z0(),M=E.useMemo(()=>fm(u,f,v,p,c,"data"),[u,f,v,p,c]),N=E.useMemo(()=>fm(u,f,v,p,c,"assets"),[u,f,v,p,c]),L=E.useMemo(()=>{if(u===c.pathname+c.search+c.hash)return[];let B=new Set,U=!1;if(f.forEach(I=>{let J=p.routes[I.route.id];!J||!J.hasLoader||(!M.some(xe=>xe.route.id===I.route.id)&&I.route.id in b&&g[I.route.id]?.shouldRevalidate||J.hasClientLoader?U=!0:B.add(I.route.id))}),B.size===0)return[];let K=Am(u,T,m.unstable_trailingSlashAwareDataRequests,"data");return U&&B.size>0&&K.searchParams.set("_routes",f.filter(I=>B.has(I.route.id)).map(I=>I.route.id).join(",")),[K.pathname+K.search]},[T,m.unstable_trailingSlashAwareDataRequests,b,c,p,M,f,u,g]),Z=E.useMemo(()=>b0(N,p),[N,p]),Q=N0(N);return E.createElement(E.Fragment,null,L.map(B=>E.createElement("link",{key:B,rel:"prefetch",as:"fetch",href:B,...d})),Z.map(B=>E.createElement("link",{key:B,rel:"modulepreload",href:B,...d})),Q.map(({key:B,link:U})=>E.createElement("link",{key:B,nonce:d.nonce,...U,crossOrigin:U.crossOrigin??d.crossOrigin})))}function R0(...u){return f=>{u.forEach(d=>{typeof d=="function"?d(f):d!=null&&(d.current=f)})}}var D0=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{D0&&(window.__reactRouterVersion="7.14.0")}catch{}function M0({basename:u,children:f,unstable_useTransitions:d,window:c}){let m=E.useRef();m.current==null&&(m.current=fg({window:c,v5Compat:!0}));let p=m.current,[g,T]=E.useState({action:p.action,location:p.location}),b=E.useCallback(v=>{d===!1?T(v):E.startTransition(()=>T(v))},[d]);return E.useLayoutEffect(()=>p.listen(b),[p,b]),E.createElement(o0,{basename:u,children:f,location:g.location,navigationType:g.action,navigator:p,unstable_useTransitions:d})}var Cm=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,se=E.forwardRef(function({onClick:f,discover:d="render",prefetch:c="none",relative:m,reloadDocument:p,replace:g,unstable_mask:T,state:b,target:v,to:M,preventScrollReset:N,viewTransition:L,unstable_defaultShouldRevalidate:Z,...Q},B){let{basename:U,navigator:K,unstable_useTransitions:I}=E.useContext(At),J=typeof M=="string"&&Cm.test(M),xe=vm(M,U);M=xe.to;let be=Vg(M,{relative:m}),Te=Bt(),W=null;if(T){let Oe=Yu(T,[],Te.unstable_mask?Te.unstable_mask.pathname:"/",!0);U!=="/"&&(Oe.pathname=Oe.pathname==="/"?U:Yt([U,Oe.pathname])),W=K.createHref(Oe)}let[Re,Ke,_t]=E0(c,Q),pt=L0(M,{replace:g,unstable_mask:T,state:b,target:v,preventScrollReset:N,relative:m,viewTransition:L,unstable_defaultShouldRevalidate:Z,unstable_useTransitions:I});function Je(Oe){f&&f(Oe),Oe.defaultPrevented||pt(Oe)}let Ot=!(xe.isExternal||p),gt=E.createElement("a",{...Q,..._t,href:(Ot?W:void 0)||xe.absoluteURL||be,onClick:Ot?Je:f,ref:R0(B,Ke),target:v,"data-discover":!J&&d==="render"?"true":void 0});return Re&&!J?E.createElement(E.Fragment,null,gt,E.createElement(T0,{page:be})):gt});se.displayName="Link";var _0=E.forwardRef(function({"aria-current":f="page",caseSensitive:d=!1,className:c="",end:m=!1,style:p,to:g,viewTransition:T,children:b,...v},M){let N=Hn(g,{relative:v.relative}),L=Bt(),Z=E.useContext(rr),{navigator:Q,basename:B}=E.useContext(At),U=Z!=null&&k0(N)&&T===!0,K=Q.encodeLocation?Q.encodeLocation(N).pathname:N.pathname,I=L.pathname,J=Z&&Z.navigation&&Z.navigation.location?Z.navigation.location.pathname:null;d||(I=I.toLowerCase(),J=J?J.toLowerCase():null,K=K.toLowerCase()),J&&B&&(J=ia(J,B)||J);const xe=K!=="/"&&K.endsWith("/")?K.length-1:K.length;let be=I===K||!m&&I.startsWith(K)&&I.charAt(xe)==="/",Te=J!=null&&(J===K||!m&&J.startsWith(K)&&J.charAt(K.length)==="/"),W={isActive:be,isPending:Te,isTransitioning:U},Re=be?f:void 0,Ke;typeof c=="function"?Ke=c(W):Ke=[c,be?"active":null,Te?"pending":null,U?"transitioning":null].filter(Boolean).join(" ");let _t=typeof p=="function"?p(W):p;return E.createElement(se,{...v,"aria-current":Re,className:Ke,ref:M,style:_t,to:g,viewTransition:T},typeof b=="function"?b(W):b)});_0.displayName="NavLink";var O0=E.forwardRef(({discover:u="render",fetcherKey:f,navigate:d,reloadDocument:c,replace:m,state:p,method:g=lr,action:T,onSubmit:b,relative:v,preventScrollReset:M,viewTransition:N,unstable_defaultShouldRevalidate:L,...Z},Q)=>{let{unstable_useTransitions:B}=E.useContext(At),U=Y0(),K=B0(T,{relative:v}),I=g.toLowerCase()==="get"?"get":"post",J=typeof T=="string"&&Cm.test(T),xe=be=>{if(b&&b(be),be.defaultPrevented)return;be.preventDefault();let Te=be.nativeEvent.submitter,W=Te?.getAttribute("formmethod")||g,Re=()=>U(Te||be.currentTarget,{fetcherKey:f,method:W,navigate:d,replace:m,state:p,relative:v,preventScrollReset:M,viewTransition:N,unstable_defaultShouldRevalidate:L});B&&d!==!1?E.startTransition(()=>Re()):Re()};return E.createElement("form",{ref:Q,method:I,action:K,onSubmit:c?b:xe,...Z,"data-discover":!J&&u==="render"?"true":void 0})});O0.displayName="Form";function U0(u){return`${u} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Rm(u){let f=E.useContext(Ll);return Ne(f,U0(u)),f}function L0(u,{target:f,replace:d,unstable_mask:c,state:m,preventScrollReset:p,relative:g,viewTransition:T,unstable_defaultShouldRevalidate:b,unstable_useTransitions:v}={}){let M=Zg(),N=Bt(),L=Hn(u,{relative:g});return E.useCallback(Z=>{if(m0(Z,f)){Z.preventDefault();let Q=d!==void 0?d:On(N)===On(L),B=()=>M(u,{replace:Q,unstable_mask:c,state:m,preventScrollReset:p,relative:g,viewTransition:T,unstable_defaultShouldRevalidate:b});v?E.startTransition(()=>B()):B()}},[N,M,L,d,c,m,f,u,p,g,T,b,v])}var H0=0,q0=()=>`__${String(++H0)}__`;function Y0(){let{router:u}=Rm("useSubmit"),{basename:f}=E.useContext(At),d=l0(),c=u.fetch,m=u.navigate;return E.useCallback(async(p,g={})=>{let{action:T,method:b,encType:v,formData:M,body:N}=g0(p,f);if(g.navigate===!1){let L=g.fetcherKey||q0();await c(L,d,g.action||T,{unstable_defaultShouldRevalidate:g.unstable_defaultShouldRevalidate,preventScrollReset:g.preventScrollReset,formData:M,body:N,formMethod:g.method||b,formEncType:g.encType||v,flushSync:g.flushSync})}else await m(g.action||T,{unstable_defaultShouldRevalidate:g.unstable_defaultShouldRevalidate,preventScrollReset:g.preventScrollReset,formData:M,body:N,formMethod:g.method||b,formEncType:g.encType||v,replace:g.replace,state:g.state,fromRouteId:d,flushSync:g.flushSync,viewTransition:g.viewTransition})},[c,m,f,d])}function B0(u,{relative:f}={}){let{basename:d}=E.useContext(At),c=E.useContext(ra);Ne(c,"useFormAction must be used inside a RouteContext");let[m]=c.matches.slice(-1),p={...Hn(u||".",{relative:f})},g=Bt();if(u==null){p.search=g.search;let T=new URLSearchParams(p.search),b=T.getAll("index");if(b.some(M=>M==="")){T.delete("index"),b.filter(N=>N).forEach(N=>T.append("index",N));let M=T.toString();p.search=M?`?${M}`:""}}return(!u||u===".")&&m.route.index&&(p.search=p.search?p.search.replace(/^\?/,"?index&"):"?index"),d!=="/"&&(p.pathname=p.pathname==="/"?d:Yt([d,p.pathname])),On(p)}function k0(u,{relative:f}={}){let d=E.useContext(Sm);Ne(d!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:c}=Rm("useViewTransitionState"),m=Hn(u,{relative:f});if(!d.isTransitioning)return!1;let p=ia(d.currentLocation.pathname,c)||d.currentLocation.pathname,g=ia(d.nextLocation.pathname,c)||d.nextLocation.pathname;return ir(m.pathname,g)!=null||ir(m.pathname,p)!=null}function G0(){const[u,f]=E.useState(!0);return E.useEffect(()=>{const d=setTimeout(()=>{f(!1)},500);return()=>clearTimeout(d)},[]),r.jsxs("div",{id:"loader",style:{opacity:u?1:0,transition:"opacity 0.5s ease",pointerEvents:u?"auto":"none"},children:[r.jsx("div",{className:"spinner"}),r.jsx("p",{className:"loader-text",children:"Loading..."})]})}function Dm(){const[u,f]=E.useState(null);E.useEffect(()=>{const m=localStorage.getItem("theme");if(m)f(m==="dark"),d(m);else{const p=window.matchMedia("(prefers-color-scheme: dark)").matches;f(p),d(p?"dark":"light")}},[]);const d=m=>{document.documentElement.classList.remove("light-theme","dark-theme"),m==="light"?document.documentElement.classList.add("light-theme"):document.documentElement.classList.add("dark-theme"),localStorage.setItem("theme",m)},c=()=>{const m=u?"light":"dark";f(!u),d(m)};return u===null?null:r.jsx("button",{onClick:c,title:u?"Switch to Light Mode":"Switch to Dark Mode",style:{background:"transparent",border:"none",color:"inherit",cursor:"pointer",fontSize:"1.2rem",padding:"8px",display:"flex",alignItems:"center",justifyContent:"center",width:"36px",height:"36px",transition:"all 0.2s ease"},onMouseEnter:m=>m.target.style.opacity="0.7",onMouseLeave:m=>m.target.style.opacity="1",children:u?r.jsx("i",{className:"fas fa-sun"}):r.jsx("i",{className:"fas fa-moon"})})}function X0({open:u,onClose:f}){return r.jsxs(r.Fragment,{children:[r.jsx("style",{children:`
        ...
        `}),r.jsxs("header",{className:"header",children:[r.jsx(se,{to:"/",className:"logo",children:r.jsx("img",{src:"./assets/icon/Freedom_Loader.png",alt:"logo"})}),r.jsxs("nav",{className:"nav",children:[r.jsxs("div",{className:`item ${u==="project"?"open":""}`,onMouseEnter:()=>f("project"),onMouseLeave:()=>f(null),children:[r.jsxs("div",{className:"trigger",children:["Project ",r.jsx("span",{className:"arrow",children:"▾"})]}),r.jsxs("div",{className:"dropdown",children:[r.jsx(se,{to:"/about",children:"About"}),r.jsx(se,{to:"/features",children:"Features"}),r.jsx(se,{to:"/roadmap",children:"Roadmap"}),r.jsx(se,{to:"/wiki",children:"Wiki"})]})]}),r.jsxs("div",{className:`item ${u==="explore"?"open":""}`,onMouseEnter:()=>f("explore"),onMouseLeave:()=>f(null),children:[r.jsxs("div",{className:"trigger",children:["Explore ",r.jsx("span",{className:"arrow",children:"▾"})]}),r.jsxs("div",{className:"dropdown",children:[r.jsx(se,{to:"/faq",children:"FAQ"}),r.jsx(se,{to:"/contact",children:"Contact"})]})]}),r.jsxs("div",{className:`item ${u==="workshop"?"open":""}`,onMouseEnter:()=>f("workshop"),onMouseLeave:()=>f(null),children:[r.jsxs("div",{className:"trigger",children:["Workshop ",r.jsx("span",{className:"arrow",children:"▾"})]}),r.jsxs("div",{className:"dropdown",children:[r.jsx("a",{href:"https://masteracnolo.github.io/Freedom-Loader-Workshop/",target:"_blank",rel:"noopener noreferrer",children:"Browse Themes"}),r.jsx("a",{href:"https://masteracnolo.github.io/Freedom-Loader-Workshop/create.html",target:"_blank",rel:"noopener noreferrer",children:"Create Theme"})]})]}),r.jsxs("div",{className:`item ${u==="contribute"?"open":""}`,onMouseEnter:()=>f("contribute"),onMouseLeave:()=>f(null),children:[r.jsxs("div",{className:"trigger",children:["Contribute ",r.jsx("span",{className:"arrow",children:"▾"})]}),r.jsxs("div",{className:"dropdown",children:[r.jsx("a",{href:"https://github.com/MasterAcnolo/Freedom-Loader",children:"GitHub"}),r.jsx(se,{to:"/contributing",children:"Guide"})]})]}),r.jsx(se,{to:"/download",className:"header-btn",children:"Download"}),r.jsx(Dm,{})]}),r.jsxs("div",{className:`hamburger ${d?"open":""}`,onClick:()=>c(!d),children:[r.jsx("span",{}),r.jsx("span",{}),r.jsx("span",{})]})]}),r.jsx(X0,{open:d,onClose:()=>c(!1)})]})}function V0(){const u=new Date().getFullYear();return r.jsxs(r.Fragment,{children:[r.jsx("style",{children:`
            ...
            `}),r.jsx("main",{children:r.jsxs("section",{className:"roadmap-page",children:[r.jsxs("div",{className:"roadmap-header",children:[r.jsx("h1",{children:"Roadmap"}),r.jsx("p",{children:"See what's coming next for Freedom Loader. We're constantly innovating and improving."})]}),r.jsx("div",{className:"roadmap-container",children:Object.entries(d).map(([m,p],g)=>r.jsxs("div",{className:`roadmap-section ${m==="Coming Soon"?"coming-soon":m==="Working On"?"in-dev":"future"}`,children:[r.jsxs("div",{className:"section-header",children:[r.jsx("div",{className:"section-dot",style:{backgroundColor:c[m]}}),r.jsx("h2",{className:"section-title",children:m})]}),r.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:p.map((T,b)=>r.jsxs("div",{className:`roadmap-item ${u===`${m}-${b}`?"expanded":""} ${m==="Coming Soon"?"coming-soon":m==="Working On"?"in-dev":"future"}`,onClick:()=>f(u===`${m}-${b}`?null:`${m}-${b}`),children:[r.jsxs("div",{className:"item-header",children:[r.jsx("h3",{className:"item-title",children:T.title}),r.jsx("i",{className:"fas fa-chevron-down item-icon"})]}),r.jsx("p",{className:"item-desc",children:T.desc})]},b))})]},m))})]})})]})}function ay(){return E.useEffect(()=>{document.title="Terms - Freedom Loader"},[]),r.jsxs(r.Fragment,{children:[r.jsx("style",{children:`
                .terms {
                    color: var(--text-primary);
                    padding: 80px 20%;
                    margin-top: 30px;
